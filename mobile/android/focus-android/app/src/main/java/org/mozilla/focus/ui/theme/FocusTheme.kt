...
private fun darkColorPalette(): FocusColors =
    FocusColors(
...
private fun lightColorPalette(): FocusColors =
    FocusColors(
...
private fun darkColorSchemeMaterial(): ColorScheme =
    darkColorScheme(
...
private fun lightColorSchemeMaterial(): ColorScheme =
    lightColorScheme(
