...
class GleanUsageReportingMetricsService(
    ...
    class UsageProfileId : GleanProfileId {
        ...
        /**
         * We want to unset the profile id when switching off profile reporting. There is no `<field>.unset()` method in
         * Glean. So to unset the profile id, we set it to an invalid "canary value".
         */
        companion object {
    ...
    class GleanProfileIdPreferenceStore(context: Context) : GleanProfileIdStore {
        ...
        private val preferenceKey = context.resources.getString(R.string.pref_key_glean_usage_profile_id)
