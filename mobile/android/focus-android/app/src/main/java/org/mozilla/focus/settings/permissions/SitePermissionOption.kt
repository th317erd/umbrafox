...
sealed class AutoplayOption {
    ...
    /** Option to allow both audio and video autoplay. */
    ...
    /** Option to block audio-only autoplay. */
    ...
    /** Option to block both audio and video autoplay. */
...
/** Represents the available options for a site permission. */
sealed class SitePermissionOption(open val prefKeyId: Int, open val titleId: Int, open val summaryId: Int? = null) {

    /** Option to ask the user before allowing the permission. */
    ...
    /** Option to block the permission. */
    data class Blocked(
    ...
    /** Option to allow the permission. */
    data class Allowed(
