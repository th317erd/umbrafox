...
object Performance {
    ...
    /**
     * This checks for the charging state and ADB debugging in case another application tries to leverage this intent to
     * trigger a code path for Firefox that shouldn't be used unless it is for testing visual metrics. These checks
     * aren't foolproof but most of our users won't have ADB on and charging at the same time when running Firefox.
     */
