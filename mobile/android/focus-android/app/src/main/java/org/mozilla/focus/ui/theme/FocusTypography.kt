...
/**
 * Custom Focus typography, other than baseline Material typography. Custom text styles should be added with
 * consideration, only when an existing Material style is not suitable.
 */
