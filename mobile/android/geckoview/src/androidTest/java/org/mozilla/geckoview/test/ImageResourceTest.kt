...
class ImageResourceTest : BaseSessionTest() {
    ...
    fun getBitmap() {
        ...
        sessionRule.waitForResult(
            image.getBitmap(actualWidth).then { bitmap ->
                assertThat(
