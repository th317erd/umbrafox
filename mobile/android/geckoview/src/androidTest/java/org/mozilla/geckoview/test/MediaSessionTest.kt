...
class MediaSessionTest : BaseSessionTest() {
    ...
    @Before
    fun setup() {
        sessionRule.setPrefsUntilTestEnd(mapOf("media.mediacontrol.stopcontrol.aftermediaends" to false))
    }
    ...
    fun domMetadataPlayback() {
        ...
        val completedStep3 = GeckoResult.allOf(onPauseCalled[0])
        ...
        //    a. Ensure onPause (1) is called.
        val completedStep5 = GeckoResult.allOf(onPauseCalled[1])
        ...
        val completedStep8a = GeckoResult.allOf(onPauseCalled[3])
        ...
        //    a. Ensure onPause (2) is called.
        val completedStep9 = GeckoResult.allOf(onPauseCalled[4])
        ...
        val completedStep11 = GeckoResult.allOf(onStopCalled[0])
            ...
            object : MediaSession.Delegate {
                ...
                override fun onMetadata(
                    ...
                    if (sessionRule.currentCall.counter == 7) {
                        ...
                        onMetadataCalled[sessionRule.currentCall.counter - 1].complete(null)
                        return
                    }
                ...
                override fun onPlay(
                    ...
                    onPlayCalled[sessionRule.currentCall.counter - 1].complete(null)
                }
                ...
                override fun onPause(
                    ...
                    onPauseCalled[sessionRule.currentCall.counter - 1].complete(null)
                }
    ...
    fun defaultMetadataPlayback() {
        ...
        // 4. Resume playback (1).
        //    b. Ensure onPlay (1) is called.
        val completedStep4 = GeckoResult.allOf(onPlayCalled[1])
    ...
    fun domMultiSessions() {
        ...
        val completedStep3 = GeckoResult.allOf(onPauseCalled[0][0])
        ...
        val completedStep6 = GeckoResult.allOf(onPauseCalled[1][0])
        ...
        //    a. Ensure onPause (1) is called.
        val completedStep8 = GeckoResult.allOf(onPauseCalled[0][1])
        ...
        session1.delegateUntilTestEnd(
            object : MediaSession.Delegate {
                ...
                override fun onActivated(
                    ...
                    onActivatedCalled[0][sessionRule.currentCall.counter - 1].complete(null)
                    mediaSession1 = mediaSession
                ...
                override fun onPlay(
                    ...
                    onPlayCalled[0][sessionRule.currentCall.counter - 1].complete(null)
                }
                ...
                override fun onPause(
                    ...
                    onPauseCalled[0][sessionRule.currentCall.counter - 1].complete(null)
                }
            }
        )

        session2.delegateUntilTestEnd(
            object : MediaSession.Delegate {
                @AssertCalled(count = 1)
                override fun onActivated(
                    session: GeckoSession,
                    ...
                    onActivatedCalled[1][sessionRule.currentCall.counter - 1].complete(null)
                ...
                override fun onMetadata(
                    ...
                    assertThat(
                        "Title should match",
                        meta.title,
                        equalTo(forEachCall(DOM_META[0].title)),
                    )
                    assertThat(
                        "Artist should match",
                        meta.artist,
                        equalTo(forEachCall(DOM_META[0].artist)),
                    )
                    assertThat(
                        "Album should match",
                        meta.album,
                        equalTo(forEachCall(DOM_META[0].album)),
                    )
                }
                ...
                override fun onPlay(
                    ...
                    onPlayCalled[1][sessionRule.currentCall.counter - 1].complete(null)
                }
                ...
                override fun onPause(
                    ...
                    onPauseCalled[1][sessionRule.currentCall.counter - 1].complete(null)
                }
            }
        )
    ...
    fun fullscreenVideoElementMetadata() {
        ...
        val completedStep3 = GeckoResult.allOf(onFullscreenCalled[0])

        // 4. Exit fullscreen of the video.
        //    a. Ensure onFullscreen is called.
        val completedStep4 = GeckoResult.allOf(onFullscreenCalled[1])

        // 5. Pause the video.
        //    a. Ensure onPause is called.
        val completedStep5 = GeckoResult.allOf(onPauseCalled)
        ...
        session1.delegateUntilTestEnd(
            object : MediaSession.Delegate {
                ...
                override fun onFullscreen(
                    ...
                    onFullscreenCalled[sessionRule.currentCall.counter - 1].complete(null)
                }
            }
        )
        ...
        // 3.
        session1.evaluateJS("document.querySelector('video').requestFullscreen()")
        sessionRule.waitForResult(completedStep3)
    ...
    fun fullscreenVideoWithActivated() {
        ...
        session.delegateDuringNextWait(
            object : MediaSession.Delegate {
                override fun onFullscreen(
                    session: GeckoSession,
                    mediaSession: MediaSession,
