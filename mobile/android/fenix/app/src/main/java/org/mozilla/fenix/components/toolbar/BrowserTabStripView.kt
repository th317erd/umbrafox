...
/**
 * A no-op [ScrollableToolbar] [AbstractComposeView] meant to integrate showing the tabstrip in a XML layout. Implements
 * the interface only so [EngineViewClippingBehavior] tracks its translation as a clipping dependency.
 */
