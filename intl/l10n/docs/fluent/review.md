...
[existing extensive documentation](./tutorial.md) about Fluent.
...
More examples about selector and variant abuses can be found in [this wiki](https://github.com/projectfluent/fluent/wiki/Good-Practices-for-Developers#prefer-separate-messages-over-variants-for-ui-logic).
...
helpful to first read the [Access keys](https://docs.microsoft.com/en-us/windows/uwp/design/input/access-keys) guide in the Windows Developer documentation,
...
:::{warning}
Currently, there’s an [issue](https://github.com/mozilla/code-review/issues/32) preventing warnings to be displayed in
