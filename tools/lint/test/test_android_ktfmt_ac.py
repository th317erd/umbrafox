...
SUBDIR = mozpath.join("mobile", "android", "android-components")
COMPONENTS = mozpath.join(SUBDIR, "components", "feature", "example", "src", "main")
FILE1 = mozpath.join(COMPONENTS, "java", "mozilla", "components", "File1.kt")
FILE2 = mozpath.join(COMPONENTS, "java", "mozilla", "components", "File2.kt")


def parse_results(config, topobjdir="ac"):
