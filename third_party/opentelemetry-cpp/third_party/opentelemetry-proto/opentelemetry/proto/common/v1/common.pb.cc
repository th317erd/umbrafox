  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          &EntityRef::MergeImpl,
          Super_::GetNewImpl<EntityRef>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &EntityRef::SharedDtor,
          Super_::GetClearImpl<EntityRef>(), &EntityRef::ByteSizeLong,
  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          nullptr,  // IsInitialized
          &AnyValue::MergeImpl,
          Super_::GetNewImpl<AnyValue>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &AnyValue::SharedDtor,
          Super_::GetClearImpl<AnyValue>(), &AnyValue::ByteSizeLong,
  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          Super_::GetNewImpl<ArrayValue>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &ArrayValue::SharedDtor,
          Super_::GetClearImpl<ArrayValue>(), &ArrayValue::ByteSizeLong,
  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          nullptr,  // IsInitialized
          &KeyValue::MergeImpl,
          Super_::GetNewImpl<KeyValue>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &KeyValue::SharedDtor,
          Super_::GetClearImpl<KeyValue>(), &KeyValue::ByteSizeLong,
  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          Super_::GetNewImpl<KeyValueList>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &KeyValueList::SharedDtor,
          Super_::GetClearImpl<KeyValueList>(), &KeyValueList::ByteSizeLong,
  ...
  return ::google::protobuf::internal::ClassDataLite{
      {
          ...
          Super_::GetNewImpl<InstrumentationScope>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &InstrumentationScope::SharedDtor,
          Super_::GetClearImpl<InstrumentationScope>(), &InstrumentationScope::ByteSizeLong,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, AnyValue_get_class_data()) {
  ...
  switch (value_case()) {
    case VALUE_NOT_SET:
      ...
      case kDoubleValue:
        ...
        break;
      case kArrayValue:
        _impl_.value_.array_value_ = Super_::CopyConstruct(arena, *from._impl_.value_.array_value_);
        break;
      case kKvlistValue:
        _impl_.value_.kvlist_value_ = Super_::CopyConstruct(arena, *from._impl_.value_.kvlist_value_);
        break;
      case kBytesValue:
...
void AnyValue::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  if (const uint32_t oneof_from_case =
    ...
    switch (oneof_from_case) {
      ...
      case kArrayValue: {
        if (oneof_needs_init) {
          _this->_impl_.value_.array_value_ = Super_::CopyConstruct(arena, *from._impl_.value_.array_value_);
        } else {
      ...
      case kKvlistValue: {
        if (oneof_needs_init) {
          _this->_impl_.value_.kvlist_value_ = Super_::CopyConstruct(arena, *from._impl_.value_.kvlist_value_);
        } else {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, ArrayValue_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, KeyValueList_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, KeyValue_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, InstrumentationScope_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, EntityRef_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : Super_(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
