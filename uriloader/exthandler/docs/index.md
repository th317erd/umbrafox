...
[launch the application](https://searchfox.org/mozilla-central/search?q=nsIMIMEInfo%3A%3ALaunchWithFile&path=).
...
3. If one has not been found already then try to find a type description from
   a [lookup table](https://searchfox.org/mozilla-central/search?q=extraMimeEntries[]&path=)
