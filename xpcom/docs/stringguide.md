...
- ASCII - 7-bit encoding for basic English-only strings. Each ASCII value
  ...
  set to zero.
- [UCS2](http://www.unicode.org/glossary/#UCS_2) - 16-bit encoding for a
  subset of Unicode, [BMP](http://www.unicode.org/glossary/#BMP). The Unicode
  value of a character stored in UCS2 is stored in exactly one 16-bit
  `char16_t` in a string class.
- [UTF-8](http://www.faqs.org/rfcs/rfc3629.html) - 8-bit encoding for
  ...
  repertoire, and it efficiently maps to [UTF-32](http://www.unicode.org/glossary/#UTF_32). (Gtk and Rust natively use
  UTF-8.)
- [UTF-16](http://www.unicode.org/glossary/#UTF_16) - 16-bit encoding for
...
ones are defined in the [Encoding Standard](https://encoding.spec.whatwg.org/).
...
for member variables. As described in [Local Variables], these classes have
...
used through a variety of methods including [Iterators],
