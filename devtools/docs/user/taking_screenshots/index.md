...
(taking-screenshots-taking-a-screenshot-of-the-page)=
...
(taking-screenshots-of-an-element)=

## Taking a screenshot of an element

To take a screenshot of a single element in the page, activate the context menu on that element in the {ref}`Inspector's HTML pane  <page-inspector-ui-tour-html-pane>`, and select "Screenshot Node". The screenshot is saved to the browser's "Downloads" directory:
