...
The [font-size](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-size) for the inspected element.
...
:::{note}
If you want to use a different unit such as `pt` for `font-size` or `line-height`, you can set the property value applied to the currently inspected element to use that unit via the {ref}`rules view  <page-inspector-ui-tour-rules-view>`, and the font editor will automatically pick it up and make it available in the associated units dropdown menu.
:::
...
The [line-height](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/line-height) of the inspected element.
...
The [font-weight](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-weight) for the inspected element.
...
:::{note}
For [variable fonts](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Fonts/Variable_fonts) (see below) that define a `wght` variation axis, this range is custom.
:::

### Italic

The [font-style](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-style) for the inspected element.
...
- The [@font-face](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@font-face) descriptor that loads the font into the page, in the case of web fonts. The descriptor is expandable — when opened it shows its full syntax as defined in the stylesheet.
...
All variable font axes have a four-character axis tag. The CSS [font-variation-settings](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-variation-settings) property uses the tag as part of the key-value pair. For example, to set [font-weight](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-weight) using `font-variation-settings`, you could do something like this:
...
- If you hover over the [font-family](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font-family) property in the Rules view, a tooltip shows a sample of the font:
