...
In the CSS Pane's {ref}`Rules view  <page-inspector-ui-tour-rules-view>`, if a rule contains a color value, you'll see a sample of the color next to the value:
