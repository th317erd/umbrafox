...
[CSS filter](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/filter) properties in the {ref}`Rules view  <page-inspector-ui-tour-rules-view>` have a circular gray and white swatch next to them:
