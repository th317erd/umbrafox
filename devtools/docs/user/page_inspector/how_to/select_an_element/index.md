...
myst:
  substitutions:
    image1: |-
      ```{image} node-picker.png
      :width: 20```
---

# Select an element

The *selected element* is the element in the page that the Inspector is currently focused on. The selected element is shown in the {ref}`HTML pane  <page-inspector-ui-tour-html-pane>` and its CSS is displayed in the {doc}`CSS pane <../../ui_tour/index>`.
...
(page-inspector-how-to-select-an-element-with-the-node-picker)=
