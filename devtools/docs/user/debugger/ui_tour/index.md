...
- {ref}`Source pane  <debugger-ui-tour-source-pane>`
...
- A settings menu that contains:
  ...
  - **Wrap Lines**: Toggles wrapping of long lines in the {ref}`source pane  <debugger-ui-tour-source-pane>`.
...
(debugger-ui-tour-breakpoints-list)=
...
:alt: FF Debugger showing callstack with right-menu and marked up unignore/ignore source
:  "eye"
:class: border
```
