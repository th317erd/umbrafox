...
Let's take a look at how this works. If you want to follow along, use [this example](https://firefox-dev.tools/debugger-examples/examples/increment/).

1. Open the [example page](https://firefox-dev.tools/debugger-examples/examples/increment/) and then open the debugger using **Tools > Web Developer > Debugger** (or press {kbd}`Ctrl` + {kbd}`I` and then select the debugger).
