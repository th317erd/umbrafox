...
:alt: 'Screenshot of the Storage Inspector where the context menu is displayed on top
:  of a local storage item whose key is "sampleList". The context menu has the following
:  entries: "Add Item", "Delete sampleList" and "Delete All"'
:class: border
```
