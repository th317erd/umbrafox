...
- *Storage* — The [storage type](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Browser_storage_limits_and_eviction_criteria#different_types_of_data_storage) specified for the database.
...
- *Key* — The [keyPath](https://developer.mozilla.org/en-US/docs/Web/API/IDBIndex/keyPath) property of the object store.
