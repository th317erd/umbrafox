...
The DOM Property Viewer lets you inspect the properties of the [DOM](https://developer.mozilla.org/en-US/docs/Glossary/DOM) as an expandable tree structure, starting from the [window](https://developer.mozilla.org/en-US/docs/Web/API/Window) object of the current page or the {doc}`selected iframe <../working_with_iframes/index>`.
