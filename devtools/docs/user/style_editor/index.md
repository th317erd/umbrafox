...
(style-editor-the-style-sheet-pane)=
...
(style-editor-the-at-rules-sidebar)=
...
Now, if you check "Show original sources" in the {ref}`Style Editor settings <settings-style-editor>`, the links next to CSS rules in the {ref}`Rules view  <page-inspector-ui-tour-rules-view>` will link to the original sources in the Style Editor.
...
(style-editor-keyboard-shortcuts)=
