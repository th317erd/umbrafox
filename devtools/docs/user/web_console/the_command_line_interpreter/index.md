...
(command-line-interpreter-multi-line-mode)=
...
(command-line-interpreter-autocomplete)=
...
(command-line-interpreter-execution-history)=
...
The expression history is persisted across sessions. To clear the history, use the `clearHistory()` {ref}`helper function  <command-line-interpreter-helper-commands>`.
...
(command-line-interpreter-helper-commands)=
