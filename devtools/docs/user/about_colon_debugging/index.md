...
(about-colon-debugging-connecting-to-a-remote-device)=
...
2. Enable "USB debugging" in the Android Developer settings.
   [Detailed guide for 1. and 2.](https://developer.android.com/studio/debug/dev-options)
...
:alt: The connected browser has an old version (68.2.0). The minimum supported version
:  (69.0a1). This is an unsupported setup and may cause DevTools to fail. Please update
...
:alt: This version of Firefox cannot debug Firefox for Android (68). We recommend installing
:  Firefox for Android Nightly on your phone for testing. More details
:class: center
```
...
(about-colon-debugging-connecting-to-android-over-wi-fi)=
...
:alt: Screenshot of the debugging panel for a service worker that is in the Running
:  state
:class: center
```
