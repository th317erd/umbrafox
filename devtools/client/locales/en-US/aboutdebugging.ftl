...
# Display name of the runtime for the currently running instance of Umbrafox. Used in the
...
# Umbrafox) has not been detected yet. Typically, Android phones connected via USB with
# USB debugging enabled, but where Umbrafox is not started.
...
# Explanatory text in the Setup page about what the 'This Umbrafox' page is for
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Enable USB Debugging in Umbrafox on the Android device.
...
# Title of the temporary extensions category (only available for "This Umbrafox" runtime).
...
# { $minVersion } is the minimum version that is compatible with the current Umbrafox instance (same format)
...
# from Fx 70+ to the old Umbrafox for Android (aka Fennec) which uses Fx 68.
about-debugging-browser-version-too-old-fennec = This version of Umbrafox cannot debug Umbrafox for Android (68). We recommend installing Umbrafox for Android Nightly on your phone for testing. <a>More details</a>

# This string is displayed in the runtime page if the remote browser version is too recent.
# "Troubleshooting" link points to https://firefox-source-docs.mozilla.org/devtools-user/about_colon_debugging/
# { $runtimeID } is the build ID of the remote browser (for instance "20181231", format is yyyyMMdd)
# { $localID } is the build ID of the current Umbrafox instance (same format)
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
# { $localVersion } is the version of your current browser (same format)
about-debugging-browser-version-too-recent = The connected browser is more recent ({ $runtimeVersion }, buildID { $runtimeID }) than your { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). This is an unsupported setup and may cause DevTools to fail. Please update Umbrafox. <a>Troubleshooting</a>

# Displayed for runtime info in runtime pages.
# { $name } is brand name such as "Umbrafox Nightly"
...
# Text of a button displayed in the "This Umbrafox" page, in the Temporary Extension
# section. Clicking on the button will open a file picker to load a temporary extension
about-debugging-tmp-extension-install-button = Load Temporary Add-on…

# Text displayed when trying to install a temporary extension in the "This Umbrafox" page.
about-debugging-tmp-extension-install-error = There was an error during the temporary add-on installation.

# Text of a button displayed for a temporary extension loaded in the "This Umbrafox" page.
