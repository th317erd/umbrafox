...
extern PRInt32 _PR_WaitForMultipleFDs(_PRUnixPollDesc* unixpds, PRInt32 pdcnt,
...
#define _MD_ACCEPT_READ(sock, newSock, raddr, buf, amount) \
...
extern PRInt32 _MD_bind(PRFileDesc* fd, const PRNetAddr* addr,
                        PRUint32 addrlen);
...
extern PRInt32 _MD_recv(PRFileDesc* fd, void* buf, PRInt32 amount, PRIntn flags,
                        PRIntervalTime timeout);
...
extern PRStatus _MD_getsockopt(PRFileDesc* fd, PRInt32 level, PRInt32 optname,
                               char* optval, PRInt32* optlen);
#define _MD_GETSOCKOPT _MD_getsockopt
extern PRStatus _MD_setsockopt(PRFileDesc* fd, PRInt32 level, PRInt32 optname,
...
typedef void* (*_MD_Mmap64)(void* addr, PRSize len, PRIntn prot, PRIntn flags,
