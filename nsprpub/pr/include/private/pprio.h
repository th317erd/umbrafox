...
NSPR_API(void)
PR_ChangeFileDescNativeHandle(PRFileDesc*, PROsfd);
NSPR_API(PRFileDesc*)
...
*/
NSPR_API(PRInt32)
PR_EmulateSendFile(PRFileDesc* networkSocket, PRSendFileData* sendData,
...
*/
NSPR_API(void)
PR_NTFast_UpdateAcceptContext(PRFileDesc* acceptSock, PRFileDesc* listenSock);
