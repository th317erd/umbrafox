...
static void
AddThreadToCVWaitQueueInternal(PRThread* thred,
                               struct _MDCVar* cv)
{
 ...
 */
static void
md_UnlockAndPostNotifies(_MDLock* lock, PRThread* waitThred,
                         _MDCVar* waitCV)
{
    PRIntn index;
    _MDNotified post;
 ...
 */
static void
md_PostNotifyToCvar(_MDCVar* cvar, _MDLock* lock,
                    PRBool broadcast)
{
    PRIntn index = 0;
