...
PRStatus
_PR_MD_CREATE_THREAD(PRThread* thread, void (*start)(void*),
...
PRThread*
_PR_MD_CREATE_USER_THREAD(PRUint32 stacksize, void (*start)(void*),
                          void* arg)
{
    PRThread* thread;
...
void
_PR_MD_INIT_CONTEXT(PRThread* thread, char* top, void (*start)(void),
                    PRBool* status)
{
