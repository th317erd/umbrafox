...
PRInt32
_AIX_AtomicSet(PRInt32* val, PRInt32 newval)
{
    PRIntn oldval;
    boolean_t stored;
...
int
_MD_SELECT(int width, fd_set* r, fd_set* w, fd_set* e, struct timeval* t)
{
    int rv;
...
int
_MD_POLL(void* listptr, unsigned long nfds, long timeout)
{
    int rv;
