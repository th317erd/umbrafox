...
static TimerEvent*
CreateTimer(PRIntervalTime timeout, void (*func)(void*),
            void* arg)
{
    TimerEvent* timer;
    PRCList *links, *tail;
...
static _PR_HashStory
MW_AddHashInternal(PRRecvWait* desc, _PRWaiterHash* hash)
{
    /*
...
static _PR_HashStory
MW_ExpandHashInternal(PRWaitGroup* group)
{
    PRRecvWait** desc;
...
#ifndef WINNT
static void
_MW_DoneInternal(PRWaitGroup* group, PRRecvWait** waiter,
                 PRMWStatus outcome)
{
    /*
...
static PRRecvWait**
_MW_LookupInternal(PRWaitGroup* group, PRFileDesc* fd)
{
    /*
...
#ifndef WINNT
static PRStatus
_MW_PollInternal(PRWaitGroup* group)
{
    PRRecvWait** waiter;
...
static PRMWGroupState
MW_TestForShutdownInternal(PRWaitGroup* group)
{
...
#ifndef WINNT
static void
_MW_InitialRecv(PRCList* io_ready)
{
...
static PRStatus
NT_HashRemove(PRWaitGroup* group, PRFileDesc* fd)
{
    PRRecvWait** waiter;
...
PRStatus
NT_HashRemoveInternal(PRWaitGroup* group, PRFileDesc* fd)
{
    PRRecvWait** waiter;
...
PR_IMPLEMENT(PRWaitGroup*)
PR_CreateWaitGroup(PRInt32 size /* ignored */)
{
    PRWaitGroup* wg;
...
PR_IMPLEMENT(PRMWaitEnumerator*)
