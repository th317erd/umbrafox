...
*/
static int
fill2(SprintfState* ss, const char* src, int srclen, int width,
      int flags)
{
    char space = ' ';
    int rv;
...
*/
static int
fill_n(SprintfState* ss, const char* src, int srclen, int width,
...
*/
static int
cvt_ll(SprintfState* ss, PRInt64 num, int width, int prec, int radix,
       int type, int flags, const char* hexp)
{
    char cvtbuf[100];
    char* cvt;
...
*/
static int
cvt_f(SprintfState* ss, double d, const char* fmt0,
      const char* fmt1)
{
    char fin[20];
    char fout[300];
...
*/
static int
cvt_s(SprintfState* ss, const char* str, int width, int prec,
      int flags)
{
    int slen;
...
BuildArgArray(const char* fmt, va_list ap, int* rv,
...
static int
FuncStuff(SprintfState* ss, const char* sp, PRUint32 len)
{
    int rv;
...
*/
static int
GrowStuff(SprintfState* ss, const char* sp, PRUint32 len)
{
    ptrdiff_t off;
    char* newbase;
    PRUint32 newlen;
...
*/
PR_IMPLEMENT(void)
PR_smprintf_free(char* mem) { PR_DELETE(mem); }
...
*/
static int
LimitStuff(SprintfState* ss, const char* sp, PRUint32 len)
{
