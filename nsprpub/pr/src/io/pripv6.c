 ...
 */
static void
_PR_ConvertToIpv4NetAddr(const PRNetAddr* src_v6addr,
 ...
 */
static void
_PR_ConvertToIpv6NetAddr(const PRNetAddr* src_v4addr,
...
Ipv6ToIpv4SocketBind(PRFileDesc* fd,
...
static PRStatus PR_CALLBACK
Ipv6ToIpv4SocketConnect(PRFileDesc* fd,
                        const PRNetAddr* addr,
...
Ipv6ToIpv4SocketSendTo(PRFileDesc* fd,
                       const void* buf,
...
Ipv6ToIpv4SocketAccept(PRFileDesc* fd,
                       PRNetAddr* addr,
                       PRIntervalTime timeout)
{
    PRStatus rv;
...
static PRInt32 PR_CALLBACK
Ipv6ToIpv4SocketAcceptRead(PRFileDesc* sd,
                           PRFileDesc** nd,
...
static PRStatus PR_CALLBACK
Ipv6ToIpv4SocketGetName(PRFileDesc* fd,
                        PRNetAddr* ipv6addr)
{
    PRStatus result;
    PRNetAddr tmp_ipv4addr;
...
static PRStatus PR_CALLBACK
Ipv6ToIpv4SocketGetPeerName(PRFileDesc* fd,
                            PRNetAddr* ipv6addr)
{
    PRStatus result;
    PRNetAddr tmp_ipv4addr;
...
static PRInt32 PR_CALLBACK
Ipv6ToIpv4SocketRecvFrom(PRFileDesc* fd, void* buf,
                         PRInt32 amount,
                         PRIntn flags,
                         PRNetAddr* ipv6addr,
                         PRIntervalTime timeout)
