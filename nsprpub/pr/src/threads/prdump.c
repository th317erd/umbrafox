...
PRUint32
_PR_DumpPrintf(PRFileDesc* fd, const char* fmt, ...)
{
    char buf[100];
    PRUint32 nb;
    va_list ap;
...
void
_PR_DumpThread(PRFileDesc* fd, PRThread* thread)
{
...
static void
DumpThreadQueue(PRFileDesc* fd, PRCList* list)
{
#ifndef _PR_GLOBAL_THREADS_ONLY
    PRCList* q;
