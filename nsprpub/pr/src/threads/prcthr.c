...
*/
void
_PR_CleanupThread(PRThread* thread)
{
...
PR_GetThreadID(PRThread* thread) { return thread->id; }
...
PR_IMPLEMENT(void)
SetExecutionEnvironment(PRThread* thread, void* env)
{
...
PR_IMPLEMENT(void)
PR_SetThreadRecycleMode(PRUint32 count)
{
