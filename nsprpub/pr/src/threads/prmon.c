 ...
 */
static void
_PR_PostNotifyToMonitor(PRMonitor* mon, PRBool broadcast)
{
    PR_ASSERT(mon != NULL);
...
static void
_PR_PostNotifiesFromMonitor(PRCondVar* cv, PRIntn times)
{
    PRStatus rv;
...
PRUint32
_PR_MonitorToString(PRMonitor* mon, char* buf, PRUint32 buflen)
{
    PRUint32 nb;
