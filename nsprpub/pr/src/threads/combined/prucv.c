...
*/
PRBool
_PR_NotifyThread(PRThread* thread, PRThread* me)
{
    PRBool rv;
 ...
 */
void
_PR_NotifyLockedThread(PRThread* thread)
{
...
*/
PRStatus
_PR_WaitCondVar(PRThread* thread, PRCondVar* cvar, PRLock* lock,
...
void
_PR_NotifyCondVar(PRCondVar* cvar, PRThread* me)
{
#ifdef _PR_GLOBAL_THREADS_ONLY
...
*/
PRUint32
_PR_CondVarToString(PRCondVar* cvar, char* buf, PRUint32 buflen)
{
    PRUint32 nb;
...
PRStatus
_PR_InitCondVar(PRCondVar* cvar, PRLock* lock)
{
    PR_ASSERT(lock != NULL);
...
void
_PR_FreeCondVar(PRCondVar* cvar)
{
