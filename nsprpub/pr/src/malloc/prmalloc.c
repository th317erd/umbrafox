...
void*
_PR_UnlockedMalloc(size_t size)
{
    void* result;
...
void*
_PR_UnlockedMemalign(size_t alignment, size_t size)
{
    void* result;
...
void*
_PR_UnlockedCalloc(size_t n, size_t nelem)
{
    void* p;
 ...
 */
void*
_PR_UnlockedRealloc(void* ptr, size_t size)
{
    void* p;
