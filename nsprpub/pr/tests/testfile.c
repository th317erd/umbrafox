...
static void PR_CALLBACK
DirTestVoid(void* argunused)
{
    (void)DirTest(argunused);
}

PRThread*
create_new_thread(PRThreadType type, nativeStartType nativeStart,
...
#if defined(_PR_PTHREADS)
static void* PR_CALLBACK
File_Write_Wrapper(void* argunused)
{
...
#if defined(_PR_PTHREADS)
static void* PR_CALLBACK
File_Read_Wrapper(void* argunused)
{
