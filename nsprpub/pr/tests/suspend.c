...
print_thread(PRThread* thread, int i, void* arg)
{
    PRInt32 words;
    PRWord* registers;
...
static void
Level_0_Thread(PRThreadScope scope1, PRThreadScope scope2)
{
    PRThread* thr;
