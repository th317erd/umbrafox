...
typedef enum { rcv_get_debit,
               rcv_send_credit,
               rcv_data } RcvState;
typedef enum { xmt_send_debit,
               xmt_recv_credit,
               xmt_data } XmtState;
...
MyPoll(PRFileDesc* fd, PRInt16 in_flags,
       PRInt16* out_flags)
{
...
MyAccept(PRFileDesc* fd, PRNetAddr* addr,
...
static PRInt32 PR_CALLBACK
MySend(PRFileDesc* fd, const void* buf,
