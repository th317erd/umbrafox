...
*/
static void
PutCBData(CircBuf* cbp, void* data)
{
    PR_Lock(cbp->bufLock);
...
static void
CondWaitContextSwitch(PRThreadScope scope1, PRThreadScope scope2)
{
    PRThread *t1, *t2;
    CircBuf* cbp;
