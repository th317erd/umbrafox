...
static void
PrintExplodedTime(const PRExplodedTime* et)
{
    PRInt32 totalOffset;
...
static int
ExplodedTimeIsEqual(const PRExplodedTime* et1,
...
void
add_time_increment(PRExplodedTime* et1, time_increment_t* it)
{
