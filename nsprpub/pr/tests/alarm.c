...
ConditionNotify(PRUint32 loops)
{
    PRThread* thread;
...
static PRIntervalTime
ConditionTimeout(PRUint32 loops)
{
    PRUintn count;
...
static PRBool
AlarmFn1(PRAlarmID* id, void* clientData, PRUint32 late)
{
...
static PRBool
AlarmFn2(PRAlarmID* id, void* clientData, PRUint32 late)
{
    PRBool keepGoing;
    PRStatus rv = PR_SUCCESS;
    AlarmData* ad = (AlarmData*)clientData;
...
static PRUint32
TimeThis(const char* msg, PRUint32 (*func)(PRUint32 loops),
         PRUint32 loops)
{
