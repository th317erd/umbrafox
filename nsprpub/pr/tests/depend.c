...
static void
PrintVersion(const char* msg, const PRVersion* info, PRIntn tab)
{
    static const len = 20;
...
static void
ChaseDependents(const PRVersionInfo* info, PRIntn tab)
{
...
static const PRDependencyInfo*
DummyImports(const PRDependencyInfo* previous)
{
    if (NULL == previous) {
