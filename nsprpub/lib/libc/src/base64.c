...
static void
encode3to4(const unsigned char* src, unsigned char* dest)
{
...
static void
encode2to4(const unsigned char* src, unsigned char* dest)
{
...
static void
encode1to4(const unsigned char* src, unsigned char* dest)
{
    dest[0] = base[(PRUint32)((src[0] >> 2) & 0x3F)];
...
static void
encode(const unsigned char* src, PRUint32 srclen,
       unsigned char* dest)
{
    while (srclen >= 3) {
        encode3to4(src, dest);
...
static PRStatus
decode4to3(const unsigned char* src, unsigned char* dest)
{
    PRUint32 b32 = (PRUint32)0;
    PRInt32 bits;
    PRIntn i;
...
static PRStatus
decode3to2(const unsigned char* src, unsigned char* dest)
{
    PRUint32 b32 = (PRUint32)0;
    PRInt32 bits;
    PRUint32 ubits;
...
static PRStatus
decode2to1(const unsigned char* src, unsigned char* dest)
{
    PRUint32 b32;
    PRUint32 ubits;
    PRInt32 bits;
...
static PRStatus
decode(const unsigned char* src, PRUint32 srclen,
       unsigned char* dest)
{
    PRStatus rv;
