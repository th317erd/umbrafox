...
mailto-handler-picker-subtitle = Pick the app you’d like to use for email links. You can change this later in Settings.
...
mailto-handler-picker-always-ask = Always ask me when I click an email link
