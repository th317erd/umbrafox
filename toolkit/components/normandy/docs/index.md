...
:::{note}
Previously, the recipes were fetched from the [recipe server], but in [Bug 1513854]
...
[bug 1513854]: https://bugzilla.mozilla.org/show_bug.cgi?id=1513854
[recipe server]: https://github.com/mozilla/normandy/
