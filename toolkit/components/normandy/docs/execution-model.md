...
For more information, see [the suitabilities docs](./suitabilities.html).

### Signature

First, recipes are validated using a signature generated by [Autograph] that
...
written in an expression language named [JEXL] that is similar to JavaScript,
...
[jexl]: https://github.com/mozilla/mozjexl
