...
- [Vision for WebExtensions](https://wiki.mozilla.org/WebExtensions/Vision)
- [API Policies](https://wiki.mozilla.org/WebExtensions/policy)
- [Process for creating new APIs](https://wiki.mozilla.org/WebExtensions/NewAPIs)
...
- **Namespace**:
  ...
  [tabs API](https://developer.mozilla.org/en-US/Add-ons/WebExtensions/API/tabs)
...
- **Environments**:
  ...
  accessed via [`browser.runtime.getURL()`](https://developer.mozilla.org/en-US/Add-ons/WebExtensions/API/runtime/getURL).
...
- **Functions**:
  ...
  [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise). Even functions that do not return a result
...
see the
[browser action](https://developer.mozilla.org/en-US/Add-ons/WebExtensions/API/browserAction)
API for an example.
