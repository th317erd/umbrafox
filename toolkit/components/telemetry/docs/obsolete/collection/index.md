...
*Note:* Every new data collection must go through a [data collection review](https://wiki.mozilla.org/Firefox/Data_Collection).
...
- Firefox 61: Stopped reporting Telemetry Log items ([bug 1443614](https://bugzilla.mozilla.org/show_bug.cgi?id=1443614)).
