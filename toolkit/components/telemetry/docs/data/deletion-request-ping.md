...
It is [known](https://bugzilla.mozilla.org/show_bug.cgi?id=1741252) that,
...
- Firefox 72:
  ...
  - "deletion-request" ping replaces the "optout" ping ([bug 1585410](https://bugzilla.mozilla.org/show_bug.cgi?id=1585410)).

- Firefox 73:

  - Added support for subordinate ids in the "deletion-request" store ([bug 1604312](https://bugzilla.mozilla.org/show_bug.cgi?id=1604312)).
