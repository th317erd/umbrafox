...
The tree's current version of the protobuf library is 36.0.
...
1. Decide the protobuf release version you want to vendor (for example, `v36.0`).
...
```bash
mach vendor toolkit/components/protobuf/moz.yaml -r v36.0 --patch-mode none
```
...
```
   ...
   Where `-r v36.0` specifies the protobuf version.
