...
of an [\<iframe>](https://developer.mozilla.org/docs/Web/HTML/Element/iframe) that is
...
612625](https://bugzilla.mozilla.org/show_bug.cgi?id=612625).
...
626168](https://bugzilla.mozilla.org/show_bug.cgi?id=626168) was an
