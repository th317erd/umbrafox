...
}, 'decodingInfo: AV1 with no fmtp params is supported');
...
}, 'decodingInfo: AV1 with no level-idx at 1080p is not capped by the default level 3.1');
...
}, 'decodingInfo: AV1 explicit level-idx=5 (3.1) at 1080p exceeds the level cap and is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'decodingInfo: AV1 with valid profile/level-idx/tier is supported');
...
}, 'decodingInfo: AV1 with invalid profile is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with an undefined-but-named level-idx is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with a reserved level-idx is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with an out-of-range level-idx is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with an invalid tier is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 high tier with an explicit level below 4.0 is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'decodingInfo: AV1 high tier at level 4.0 is supported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'decodingInfo: AV1 high tier with no level-idx is supported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with a non-numeric level-idx is unsupported');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 with a level-idx with trailing junk is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'decodingInfo: AV1 level-idx=31 (Maximum parameters) imposes no resolution cap');
...
promise_test(async () => {
  ...
  assert_false(info.supported);
}, 'decodingInfo: AV1 level-idx=1 (2.1) at 3840x2160 exceeds the level cap and is unsupported');
...
promise_test(async () => {
  ...
  assert_true(info.supported);
}, 'decodingInfo: AV1 level-idx=1 (2.1) at 640x360 fits the level cap and is supported');
