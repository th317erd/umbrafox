# Splitting a commit with jj

Mechanics for `stack-split-commit` in a Jujutsu checkout. Read `SKILL.md`
first for the by-concern rule and the message handling, which hold whichever
tool you use.
