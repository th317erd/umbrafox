...
+--------------------------------------------------------+-------------+--------------------------------------+
| :ref:`mozilla-projects-nss-cert-findcertbydercert`     | MXR         | 3.2 and later                        |
|                                                        |             |                                      |
+--------------------------------------------------------+-------------+--------------------------------------+
| :ref:`mozilla-projects-nss-cert-findcertbyissuerandsn` | MXR         | 3.2 and later                        |
|                                                        |             |                                      |
+--------------------------------------------------------+-------------+--------------------------------------+
...
+--------------------------------------------------------+-------------+--------------------------------------+
| :ref:`mozilla-projects-nss-ssl-functions-sslcrt`       | MXR         | 3.2 and later. If you need to verify |
|                                                        |             | for multiple usages use              |
