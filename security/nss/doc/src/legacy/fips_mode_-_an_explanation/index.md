(mozilla-projects-nss-fips-mode-an-explanation)=
...
[support.mozilla.com](https://support.mozilla.com/en-US/kb/Configuring+Firefox+for+FIPS+140-2).
:::
...
NSS
wiki](https://wiki.mozilla.org/FIPS_Validation#Products_Implementing_FIPS_140-2_Validated_NSS).
:::
