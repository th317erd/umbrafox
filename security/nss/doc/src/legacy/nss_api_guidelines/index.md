...
|          | through certhi.                                                                                                                                                                                                                                                                                                                                                                                                    |                   |               |                     |
+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------+---------------+---------------------+
| crmf     | Provides functions, and data types, to handle Certificate Management Message Format (CMMF) and Certificate Request Message Format (CRMF, see `RFC2511 <https://datatracker.ietf.org/doc/html/rfc2511>`__) data. CMMF no longer exists as a proposed standard; CMMF functions have been incorporated into the proposal for `CertificateManagementProtocols(CMP) <https://datatracker.ietf.org/doc/html/rfc2510>`__. | Same Level as SSL | lib/crmf      | cmmf.h, crmf.h,     |
|          |                                                                                                                                                                                                                                                                                                                                                                                                                    |                   |               | crmft.h, cmmft.h,   |
|          |                                                                                                                                                                                                                                                                                                                                                                                                                    |                   |               | crmffut.h           |
|          |                                                                                                                                                                                                                                                                                                                                                                                                                    |                   |               |                     |
|          |                                                                                                                                                                                                                                                                                                                                                                                                                    |                   |               |                     |
