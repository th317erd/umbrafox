...
static const oidValDef kxOptList[] = {
    ...
    { CIPHER_NAME("MLKEM512"), SEC_OID_ML_KEM_512,
      NSS_USE_ALG_IN_SSL_KX | NSS_USE_ALG_IN_SMIME_KX },
    { CIPHER_NAME("MLKEM768"), SEC_OID_ML_KEM_768,
      NSS_USE_ALG_IN_SSL_KX | NSS_USE_ALG_IN_SMIME_KX },
    { CIPHER_NAME("MLKEM1024"), SEC_OID_ML_KEM_1024,
      NSS_USE_ALG_IN_SSL_KX | NSS_USE_ALG_IN_SMIME_KX },
