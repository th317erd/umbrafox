...
resolution](https://wiki.mozilla.org/BMO/UserGuide/BugStatuses#Resolutions).
...
with adequate
documentation](http://blog.humphd.org/why-good-first-bugs-often-arent/).)
...
or use [the GitHub settings app](https://github.com/probot/settings).
