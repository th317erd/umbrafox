...
Static Analysis is running an analysis of the source code without actually executing the code. For the most part, at Mozilla static analysis refers to the stuff we do with [clang-tidy](http://clang.llvm.org/extra/clang-tidy/). It uses
