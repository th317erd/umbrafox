...
neovim), this will populate the [quickfix list] with the errors.
...
Mach lint can also integrate with [Jujutsu SCM's] `jj fix` command. Add
...
[black (python)]: https://black.readthedocs.io/en/stable/editor_integration.html
[eslint]: https://eslint.org/docs/user-guide/integrations#editors
[jujutsu scm's]: https://jj-vcs.github.io/jj/latest/
