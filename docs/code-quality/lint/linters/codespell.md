...
[codespell](https://github.com/codespell-project/codespell/) is a popular tool to look for typical typos in the source code.
...
This job is configured as [tier 2](https://wiki.mozilla.org/Sheriffing/Job_Visibility_Policy#Overview_of_the_Job_Visibility_Tiers).
