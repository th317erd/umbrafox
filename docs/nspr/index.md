...
- [Mailing list](https://lists.mozilla.org/listinfo/dev-tech-nspr)
- [Newsgroup](http://groups.google.com/group/mozilla.dev.tech.nspr)
- [RSS
  feed](http://groups.google.com/group/mozilla.dev.tech.nspr/feeds)
