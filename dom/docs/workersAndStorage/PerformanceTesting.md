...
Our performance tests are mochitests running in the [mozperftest](https://firefox-source-docs.mozilla.org/testing/perfdocs/mozperftest.html)
...
numeric value. See the [performance scripts documentation](https://firefox-source-docs.mozilla.org/testing/perfdocs/writing.html#mochitest)
for more.

They can be run via mach perftest, or as normal mochitests via mach test.
(Currently we can’t run the full manifest, see [bug 1865852](https://bugzilla.mozilla.org/show_bug.cgi?id=1865852).)
...
Results can be found in treeherder on [mozilla-central](https://treeherder.mozilla.org/jobs?repo=mozilla-central&searchStr=perftest)
and [autoland](https://treeherder.mozilla.org/jobs?repo=autoland&searchStr=perftest). Look
for linux-sw, macosx-sw, and win-sw ([example](https://treeherder.mozilla.org/perfherder/graphs?series=mozilla-central,4967140,1,15&selected=4967140,1814245176)).
...
[Gregory Mierzwinski](https://people.mozilla.org/p/sparky)
