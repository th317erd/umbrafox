...
[the implementation bug 1852098](https://bugzilla.mozilla.org/show_bug.cgi?id=1852098#c11).)
...
See [bug 1860635](https://bugzilla.mozilla.org/show_bug.cgi?id=1860635) for a sample
...
[bug 1852098](https://bugzilla.mozilla.org/show_bug.cgi?id=1852098).
...
can fall under
[the over-arching data collection review request](https://bugzilla.mozilla.org/show_bug.cgi?id=1852098).
...
[the #data-stewards channel on Matrix](https://chat.mozilla.org/#/room/#data-stewards:mozilla.org).
...
There's a public [dashboard](https://mozilla.github.io/use-counters/) to view
the aggregated data which should update daily.

If you're a Mozilla employee, you can also browse the data directly on
[the Glean Dictionary](https://dictionary.telemetry.mozilla.org/apps/firefox_desktop?page=1&search=use.counter).
