...
class DefaultCodecPreferences : public JsepCodecPreferences {
 public:
...
class DefaultCodecPreferencesWithRtxOverride : public DefaultCodecPreferences {
 public:
  explicit DefaultCodecPreferencesWithRtxOverride(
      OverrideRtxPreference aOverrideRtxPreference)
      : mOverrideRtxEnabled(aOverrideRtxPreference) {}

  // Allows copying but changing the OverrideRTX flag.
  DefaultCodecPreferencesWithRtxOverride(
      const DefaultCodecPreferences& aPrefs,
      OverrideRtxPreference aOverrideRtxPreference)
      : DefaultCodecPreferences(aPrefs),
        mOverrideRtxEnabled(aOverrideRtxPreference) {}

  bool UseRtx() const override {
    if (mOverrideRtxEnabled == OverrideRtxPreference::NoOverride) {
      return DefaultCodecPreferences::UseRtx();
    }
