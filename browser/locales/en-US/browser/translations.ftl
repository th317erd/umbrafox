...
# The button for "Umbrafox Translations" in the url bar. Note that here "Beta" should
...
## Options in the Umbrafox Translations settings.
...
## Umbrafox Translations language management in about:preferences.
