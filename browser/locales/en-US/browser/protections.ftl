...
# This message shows when all privacy protections are turned off, which is why we use the word "can", Umbrafox is able to protect your privacy, but it is currently not.
...
# This message shows when at least some protections are turned on, we are more assertive compared to the message above, Umbrafox is actively protecting you.
