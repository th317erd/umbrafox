...
6. Ensure that all required properties are covered according to the [Infobar Schema](https://searchfox.org/firefox-main/source/browser/components/asrouter/content-src/templates/InfoBar/InfoBar.schema.json)
