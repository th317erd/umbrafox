...
curl -X POST ${SERVER}/buckets/main-workspace/collections/${CID}/records \
     -d '{"data":{"id":"EXAMPLE_INFOBAR","template":"infobar","content":{"type":"global","text":{"string_id":"default-browser-notification-message"},"buttons":[{"label":{"string_id":"default-browser-notification-button"},"primary":true,"accessKey":"O","action":{"type":"SET_DEFAULT_BROWSER"}}]},"targeting":"locale == \"en-US\" && !isDefaultBrowser","frequency":{"lifetime":3},"trigger":{"id":"defaultBrowserCheck"}}}' \
