...
More information regarding Bookmarks - [Bookmarks in Firefox]
...
1. [Add the sidebar button to your controls].
...
- [from Internet Explorer or Microsoft Edge]
- [from Google Chrome]
- [from an HTML file]
...
1. Click on *hamburger menu* button to open the Menu panel.
...
3. Select the backup from which you want to restore:
   ...
   > 2. From a manual backup ( *Choose file…* ).
...
1. Click on *hamburger menu* button to open the Menu panel.
2. Go to *Bookmarks* - *Manage Bookmarks*.
3. In the *Library window*, click the button and then select *Backup…*.
...
5. Save the bookmarks json file. The Bookmarks backup filename window will close and then you can close the *Library* window.

[add the sidebar button to your controls]: https://support.mozilla.org/en-US/kb/use-firefox-sidebar-access-bookmarks-history-synced
