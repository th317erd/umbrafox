...
:align: center
:alt: |-
:  Image of an open tab result with text "Porcupines \| San Diego Zoo
:  Animals & Plants"
:scale: 50%
...
:align: center
:alt: |-
:  Image of a remote tab result with text "Porcupine \| rodent \|
:  Britannica"
:scale: 50%
...
discussed below in [Result Composition].
...
2. A bookmark keyword? The user can associate a keyword with each bookmark.
   ...
   :align: center
   :alt: |-
   :  Image of the address bar input with text "bug 1677126" and a
...
3. A domain name or URL that should be autofilled? **Autofill** is the name of
   ...
   :align: center
   :alt: |-
   :  Image of the address bar input with text "mozilla.org/" with
...
4. A valid URL? If so, visit the URL. (This includes fixing common typos like
   ...
   List][public suffix list]. The user can also specify an allow-list using hidden preferences to
   support domains like localhost.)

   :::{figure} assets/nontechnical-overview/visit.png
   :align: center
   :alt: |-
   :  Image of the address bar input with text "porcupine-fancy.org" and a
...
5. Ultimately fall back to performing a search using the default engine. (The
   ...
   :align: center
   :alt: |-
   :  Image of the address bar input with text "porcupines" and a search
   :  heuristic result
   :scale: 50%
...
Composition Nuances](#result-composition-nuances). There are actually three types of search suggestions:
...
- Google-specific "tail" suggestions, which look like "... foo" and are provided
  ...
  :align: center
  :alt: |-
  :  Image of a tail suggestion results with text "porcupine abc def" in
...
exact number depends on certain factors (see [Result Composition Nuances]).
...
described below in [Frecency]. Tabs that match the search string are assigned
...
:align: center
:alt: |-
:  Image of the preferences UI that allows the user to opt out of search
:  suggestions
:scale: 50%
...
:align: center
:alt: |-
:  Image of the preferences UI that allows the user to choose whether
...
:align: center
:alt: |-
:  Image of the preferences UI that allows the user to choose which
:  results are shown
:scale: 50%
...
:align: center
:alt: |-
:  Image of the clear intervention result with text "Clear your cache,
...
:align: center
:alt: |-
:  Image of the refresh intervention result with text "Restore default
...
:align: center
:alt: |-
:  Image of the update intervention result with text "The latest Firefox
...
:align: center
:alt: |-
:  Image of the onboarding search tip with text "Type less, find more:
...
:align: center
:alt: |-
:  Image of the redirect search tip with text "Start your search in the
...
Tab to search allows the user to press the tab key to enter [search mode] while
...
[the frecency algorithm]: https://docs.google.com/document/d/10LRRXVGWWWcjEZIZ2YlEmuKkQqh2RaTclStFHNnPqQ8/edit#heading=h.588hanspexub
