...
: Firefox 93.0
  ...
  : Introduced. \[Bug [1727799](https://bugzilla.mozilla.org/show_bug.cgi?id=1727799)\]

  Firefox 137.0

  : Removed. \[Bug [1946922](https://bugzilla.mozilla.org/show_bug.cgi?id=1946922)\]
...
: Firefox 110.0
  ...
  : Introduced. \[Bug [1804536](https://bugzilla.mozilla.org/show_bug.cgi?id=1804536)\]
...
: Firefox 94.0.2
  ...
  : Introduced. \[Bug [1737923](https://bugzilla.mozilla.org/show_bug.cgi?id=1737923)\]
...
: Firefox 94.0.2
  ...
  : Introduced. \[Bug [1737651](https://bugzilla.mozilla.org/show_bug.cgi?id=1737651)\]

  Firefox 135.0

  : Removed. \[Bug [1932502](https://bugzilla.mozilla.org/show_bug.cgi?id=1932502)\]
...
: Firefox 94.0.2
  ...
  : Introduced `firefoxSuggestDataCollectionToggle`,
    ...
    \[Bug [1735976](https://bugzilla.mozilla.org/show_bug.cgi?id=1735976)\]
...
: Firefox 109.0
  ...
  : Introduced. \[Bug [1800993](https://bugzilla.mozilla.org/show_bug.cgi?id=1800993)\]

  Firefox 133.0

  : Removed. \[Bug [1925355](https://bugzilla.mozilla.org/show_bug.cgi?id=1925355)\]
...
: Firefox 101.0
  ...
  : Introduced. \[Bug [1761059](https://bugzilla.mozilla.org/show_bug.cgi?id=1761059)\]
...
: Firefox 101.0
  ...
  : Removed. \[Bug [1857391](https://bugzilla.mozilla.org/show_bug.cgi?id=1857391)\]
...
: Firefox 87.0
  ...
  : Introduced. \[Bug [1693927](https://bugzilla.mozilla.org/show_bug.cgi?id=1693927)\]

  Firefox 109.0

  : Removed. \[Bug [1800993](https://bugzilla.mozilla.org/show_bug.cgi?id=1800993)\]
...
: Firefox 112.0
  ...
  : Introduced. \[Bug [1819797](https://bugzilla.mozilla.org/show_bug.cgi?id=1819797)\]
...
: Firefox 99.0
  ...
  : Introduced. \[Bug [1752953](https://bugzilla.mozilla.org/show_bug.cgi?id=1752953)\]
...
: Firefox 110.0
  ...
  : Introduced. \[Bug [1806765](https://bugzilla.mozilla.org/show_bug.cgi?id=1806765)\]

  Firefox 114.0

  : Removed since the weather suggestion is no longer triggered on zero prefix.
    \[Bug [1831971](https://bugzilla.mozilla.org/show_bug.cgi?id=1831971)\]
...
: Firefox 109.0
  ...
  : Removed. \[Bug [1891602](https://bugzilla.mozilla.org/show_bug.cgi?id=1891602)\]
...
: Firefox 94.0.2
  ...
  : Introduced. \[Bug [1735976](https://bugzilla.mozilla.org/show_bug.cgi?id=1735976)\]

  Firefox 133.0

  : Removed. \[Bug [1921748](https://bugzilla.mozilla.org/show_bug.cgi?id=1921748)\]
...
: Firefox 101.0
  ...
  : `source` is added. \[Bug [1800993](https://bugzilla.mozilla.org/show_bug.cgi?id=1800993)\]
...
: Firefox 92.0.1
  ...
  : Objects changed to: `accept`, `dismissed_escape_key`,
    ...
    \[Bug [1733687](https://bugzilla.mozilla.org/show_bug.cgi?id=1733687)\]

  Firefox 96.0.2

  : Objects changed to: `accept_2`, `reject_2`, `learn_more_2`,
    `close_1`, `not_now_2`, `dismiss_1` and `dismiss_2`.
    \[Bug [1745026](https://bugzilla.mozilla.org/show_bug.cgi?id=1745026)\]
  ...
  : Objects changed to: `accept_2`, `reject_2`, `learn_more_1`,
    ...
    `dismiss_2`.
    \[Bug [1761171](https://bugzilla.mozilla.org/show_bug.cgi?id=1761171)\]
...
: Firefox 92.0.1
  ...
  : Introduced. \[Bug [1728430](https://bugzilla.mozilla.org/show_bug.cgi?id=1728430)\]
...
: Firefox 94.0
  ...
  : Introduced. \[Bug [1734447](https://bugzilla.mozilla.org/show_bug.cgi?id=1734447)\]
  ...
  : Added `accept_2`, `reject_2`, `learn_more_2`, `close_1`,
    ...
    `not_now_link`, `settings`. \[Bug [1745026](https://bugzilla.mozilla.org/show_bug.cgi?id=1745026)\]

  Firefox 100.0

  : Added `learn_more_1`. \[Bug [1761171](https://bugzilla.mozilla.org/show_bug.cgi?id=1761171)\]

  Firefox 137.0

  : Removed. \[Bug [1936455](https://bugzilla.mozilla.org/show_bug.cgi?id=1936455)\]
...
: Firefox 94.0.2
  ...
  : Removed. \[Bug [1995362](https://bugzilla.mozilla.org/show_bug.cgi?id=1995362)\]
...
: Firefox 92.0.1
  ...
  : Introduced. \[Bug [1730721](https://bugzilla.mozilla.org/show_bug.cgi?id=1730721)\]

  Firefox 94.0.2

  : Replaced with `browser.urlbar.suggest.quicksuggest.nonsponsored`. \[Bug
    [1735976](https://bugzilla.mozilla.org/show_bug.cgi?id=1735976)\]
...
: Firefox 94.0.2
  ...
  : The pref is now true by default in the online scenario. Previously it was
    ...
    online. \[Bug [1740965](https://bugzilla.mozilla.org/show_bug.cgi?id=1740965)\]

  Firefox 146.0

  : Removed. \[Bug [1995574](https://bugzilla.mozilla.org/show_bug.cgi?id=1995574)\]
...
: Firefox 116.0
  ...
  : Introduced. \[Bug [1836283](https://bugzilla.mozilla.org/show_bug.cgi?id=1836283)\]
