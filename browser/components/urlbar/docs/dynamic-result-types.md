...
[Architecture Overview](https://firefox-source-docs.mozilla.org/browser/urlbar/overview.html#urlbarprovider).
...
Let's return to the weather forecast example from [earlier](#motivation). For
