...
add_task(async function test_new_window_size() {
  SpecialPowers.pushPrefEnv({ set: [["browser.nova.enabled", false]] });
...
add_task(async function test_new_window_size_nova_enabled() {
  SpecialPowers.pushPrefEnv({ set: [["browser.nova.enabled", true]] });
