...
add_task(async function test_icon_stored() {
  for (let [pageUrl, iconUrl] of [
    [
      "https://example.net/browser/browser/base/content/test/browser-favicons/datauri-favicon.html",
    ...
    [
      "https://example.net/browser/browser/base/content/test/browser-favicons/file_favicon.html",
      "https://example.net/browser/browser/base/content/test/browser-favicons/file_favicon.png",
    ],
  ]) {
