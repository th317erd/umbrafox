...
const TEST_PAGE =
  TEST_SITE +
  "/browser/browser/base/content/test/browser-favicons/file_favicon.html";
const FAVICON_URI =
  TEST_SITE +
  "/browser/browser/base/content/test/browser-favicons/file_favicon.png";
const TEST_THIRD_PARTY_PAGE =
  TEST_SITE +
  "/browser/browser/base/content/test/browser-favicons/file_favicon_thirdParty.html";
