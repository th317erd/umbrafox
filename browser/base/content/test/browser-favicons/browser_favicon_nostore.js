...
const ICON_URL =
  TEST_SITE +
  "/browser/browser/base/content/test/browser-favicons/no-store.png";
const PAGE_URL =
  TEST_SITE +
  "/browser/browser/base/content/test/browser-favicons/no-store.html";
...
add_task(async function test_later_addition() {
  for (let iconUrl of [
    TEST_SITE + "/browser/browser/base/content/test/browser-favicons/moz.png",
