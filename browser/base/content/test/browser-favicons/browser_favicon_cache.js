add_task(async () => {
  const testPath =
    ...
    "http://example.com/browser/browser/base/content/test/browser-favicons/cookie_favicon.html";
  const resetPath =
    // eslint-disable-next-line sdl/no-insecure-url
    "http://example.com/browser/browser/base/content/test/browser-favicons/cookie_favicon.sjs?reset";
