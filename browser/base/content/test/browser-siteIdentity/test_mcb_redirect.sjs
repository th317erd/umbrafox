function handleRequest(request, response) {
  ...
  if (request.queryString === "script") {
    redirect =
      ...
      "http://example.com/browser/browser/base/content/test/browser-siteIdentity/test_mcb_redirect.js";
    ...
    redirect =
      // eslint-disable-next-line sdl/no-insecure-url
      "http://example.com/browser/browser/base/content/test/browser-siteIdentity/test_mcb_redirect.sjs?image_redirect_https";
    response.setHeader("Cache-Control", "max-age=3600", false);
