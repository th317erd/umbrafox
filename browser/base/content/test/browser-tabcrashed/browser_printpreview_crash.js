...
const TEST_URL =
  ...
  "http://example.com/browser/browser/base/content/test/browser-tabcrashed/file_contains_emptyiframe.html";
...
add_task(async function test() {
  ...
  await SpecialPowers.spawn(browser, [], async function () {
    ...
    iframe.src =
      // eslint-disable-next-line sdl/no-insecure-url
      "http://test1.example.com/browser/browser/base/content/test/browser-tabcrashed/file_iframe.html";
    await loaded;
  });
