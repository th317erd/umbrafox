...
const HTTP_ERROR_PAGE =
  "https://example.com/browser/browser/base/content/test/browser-about/http_error.sjs";
const SERVER_ERROR_PAGE =
  "https://example.com/browser/browser/base/content/test/browser-about/server_error.sjs";
