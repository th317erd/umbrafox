...
function handleRequest(request, response) {
  ...
  let txt = `<html><body><iframe src="https://example.com/browser/browser/base/content/test/browser-about/${destination}.html" width=100% height=100% sandbox="allow-popups allow-scripts allow-same-origin"></iframe></body></html>`;
  response.write(txt);
}
