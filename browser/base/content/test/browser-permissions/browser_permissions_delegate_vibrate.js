...
const TEST_PAGE =
  "https://example.com/browser/browser/base/content/test/browser-permissions/empty.html";
...
add_task(async function testNoPermissionPrompt() {
  ...
  await BrowserTestUtils.withNewTab(TEST_PAGE, async function (browser) {
    ...
    await SpecialPowers.spawn(browser, [], async function () {
      ...
      // Cross origin src
      frame.src =
        "https://example.org/browser/browser/base/content/test/browser-permissions/empty.html";
