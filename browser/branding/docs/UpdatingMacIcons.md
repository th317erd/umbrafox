...
macOS icons are stored as `icns` files that contain the same logo in multiple different sizes and DPIs. Apple's [Human Interface Guidelines](https://developer.apple.com/design/human-interface-guidelines/foundations/app-icons) should be consulted for the specifics.
