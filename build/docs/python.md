...
Only CPython (the Python distribution available from <https://www.python.org>) is
supported.
...
[venv](https://docs.python.org/3/library/venv.html). Venv provides
...
- [buildout.python](https://github.com/collective/buildout.python)
