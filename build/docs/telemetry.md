...
`./mach` uses [Sentry](https://sentry.io/welcome/)
to automatically report errors to [our issue-tracking dashboard](https://sentry.prod.mozaws.net/operations/mach/).
...
- [Sentry "Breadcrumbs"](https://docs.sentry.io/platforms/python/default-integrations/),
